...
import {TestFlowNodeViewModel} from './TestFlowNodeViewModel';
import {FreeNodePortLocationModel, Rect, TemplateNodeStyle} from 'yfiles';

export class TestFlowNodeController extends FlowNodeController {
    ...
    public init() {
        this.viewModel = new TestFlowNodeViewModel(this.model);
